...
![score area](assets/readme-files/points-area.jpg)
...
## Rules
![rules](assets/readme-files/modal.png)
...
## Choice
![choice screen](assets/readme-files/draw.png)
...
## Buttons
![buttons](assets/readme-files/buttons-rpsls.png)
...
## Mobile Version
![dark background](assets/readme-files/mobile-button.png)
- The button notifies the user that there is a different version available for mobile, while the dark background blocks the desktop version.
 ...
 ![mobile menu](assets/readme-files/mobile-version.png)
